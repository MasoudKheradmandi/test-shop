	...
	function price_slider(){
		$("#slider-range").slider({
			...
			slide: function(event, ui) {
				$("#amount").val(ui.values[0] + " هزار تومان - " + ui.values[1] + " هزارتومان ");
			}
		});
	...
	function load_more(){
        ...
        $(".loadMore").on('click', function (e) {
            ...
            if ($(".product-load-more .item:hidden").length == 0) {
                $(".infinitpagin").html('<div class="btn loadMore">محصول دیگری نیست</div>');
            }
        });
    }
	load_more();
	...
	function load_more_post(){
        ...
        $(".loadMorepost").on('click', function (e) {
            ...
            if ($(".blog--grid-load-more .article:hidden").length == 0) {
                $(".loadmore-post").html('<div class="btn loadMorepost">پست دیگری وجود ندارد</div>');
            }
        });
    }
	load_more_post();
